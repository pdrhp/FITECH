...
object ExercicioRepositorySuperiores {
    fun getExercicios(): List<Exercicio> {
        return listOf(
            Exercicio(R.drawable.sup_full_pushups_img, "Flexão Completa", "Peitoral, triceps e ombro", "Dificuldade: Média", 1,R.raw.sup_full_pushups_1,"Para tornar este exercício mais fácil: Realizar este exercício com um ligeiro declive pode torná-lo mais fácil. Isso é basicamente voltar às Flexões Inclinadas, mas com uma base a apenas um pé ou dois do chão (30-60 cm). Um banquinho ou um pufe encostado na parede funciona bem.\nPara tornar este exercício mais difícil: Realizar este exercício mais devagar pode torná-lo significativamente mais desafiador para alguns praticantes, especialmente aqueles que costumam depender do impulso."),
            Exercicio(R.drawable.sup_wall_pushup_img, "Flexão na parede", "Peitoral, tricpes e ombro", "Dificuldade: Fácil", 2,R.raw.sup_wall_pushup_2,"Para tornar este exercício mais difícil: Realize este exercício em uma moldura de porta ou anéis de ginástica para aumentar a amplitude de movimento. Desça até não conseguir mais antes de subir novamente.\nPara tornar este exercício mais fácil: Fazer isso de joelhos facilitará o exercício. No entanto, como flexões de parede são apenas um pouco mais desafiadoras do que abrir portas, você pode obter melhores resultados fazendo menos flexões de parede no início, em vez de torná-las mais fáceis."),
            Exercicio(R.drawable.sup_knee_pushups_img, "Flexão de joelhos", "Peitoral, triceps e ombro", "Dificuldade: Fácil", 3,R.raw.sup_knee_pushups_3,"Para tornar este exercício mais fácil: Uma base mais alta torna este exercício mais fácil. Mesmo alguns blocos podem ajudar.\nPara tornar este exercício mais difícil: Agachar-se sobre os joelhos e levantar-se nas pontas dos pés torna este exercício mais desafiador."),
            Exercicio(R.drawable.sup_incline_pushups_img, "Flexão inclinada", "Peitoral, triceps e ombro", "Dificuldade: Fácil", 4,R.raw.sup_incline_pushups_4,"Para tornar este exercício mais fácil: Uma base mais alta torna este exercício mais fácil.\nPara tornar este exercício mais difícil: Uma base mais baixa torna este exercício mais difícil."),
            Exercicio(R.drawable.sup_advanced_incline_pushups_img, "Flexão inclinada avançada", "Peitoral, triceps e ombro", "Dificuldade: Moderada",5,R.raw.sup_advanced_incline_pushups_5, "Para tornar este exercício mais difícil: Uma base mais baixa torna este exercício mais desafiador. Ou você pode aproximar as mãos.\nPara tornar este exercício mais fácil: Uma base mais alta facilita este exercício. Ou você pode fazer isso de joelhos, se tiver um objeto com altura equivalente à altura dos joelhos."),
            Exercicio(R.drawable.sup_narrow_pushups_img, "Flexão fechada", "Peitoral, triceps e ombro", "Dificuldade: Média/Dificil", 6,R.raw.sup_narrow_pushups_6,"Para tornar este exercício mais difícil: Aproximar as mãos uma da outra - até mesmo ao ponto em que uma mão fica em cima da outra - pode tornar este exercício mais desafiador.\nPara tornar este exercício mais fácil: Manter as mãos mais afastadas uma da outra facilita o exercício. Aproximá-las algumas polegadas uma da outra a cada poucas semanas pode ser uma maneira constante de progredir para as Flexões Estreitas.")
        )
    }
}
...
object ExercicioRepositoryAbdominais {
    fun getExercicios(): List<Exercicio> {
        return listOf(
            Exercicio(R.drawable.abd_knee_raises_img, "Elevação de joelhos", "Musculatura abdominal e lombar", "Dificuldade: Fácil", 12,R.raw.abd_knee_raises_12, "Para tornar este exercício mais fácil: Dobrar mais os joelhos facilitará este exercício.\nPara tornar este exercício mais difícil: Endireitar um pouco os joelhos tornará este exercício mais desafiador."),
            Exercicio(R.drawable.abd_advanced_knee_raises_img, "Elevação de joelhos avançada", "Musculatura abdominal e lombar", "Dificuldade: Fácil/Média",13,R.raw.abd_advanced_knee_raises_13,"Para tornar este exercício mais fácil: Dobrar mais os joelhos facilitará este exercício.\nPara tornar este exercício mais difícil: Endireitar um pouco os joelhos tornará este exercício mais desafiador."),
            Exercicio(R.drawable.abd_full_leg_raises_img, "Elevação de pernas", "Musculatura abdominal e lombar", "Dificuldade: Média", 14,R.raw.abd_full_leg_raises_14, "Para facilitar este exercício: Manter um leve flexionamento nos joelhos tornará este exercício mais fácil. Com o tempo, estique as pernas. Fazer isso mais rapidamente também facilitará. Diminua a velocidade ao longo do tempo. Queremos ter controle sobre cada parte do nosso alcance de movimento.\nPara tornar este exercício mais difícil: Mover as pernas além da posição perpendicular ao chão tornará este exercício mais desafiador. Isso é o que exploraremos na nossa próxima etapa de progressão!"),
            Exercicio(R.drawable.abd_hanging_knee_raises_img, "Elevação de joelhos suspensa", "Musculatura abdominal e lombar", "Dificuldade: Média/Difícil", 15,R.raw.abd_hanging_knee_raises_15, "Para facilitar este exercício: Manter os joelhos dobrados durante todo o exercício tornará isso mais fácil. Tenha cuidado extra para não cair sobre os joelhos, o que poderia causar ferimentos graves.\nPara tornar este exercício mais difícil: Endireitar um pouco as pernas tornará este exercício mais desafiador e o conduzirá suavemente para a próxima etapa!"),
            Exercicio(R.drawable.abd_hanging_leg_raises_img, "Elevação de pernas suspensa", "Musculatura abdominal e lombar", "Dificuldade: Difícil",16,R.raw.abd_hanging_leg_raises_16, "Para facilitar este exercício: Dobrar as pernas na subida e estendê-las na descida tornará este exercício mais fácil.\nPara tornar este exercício mais difícil: Aumentar a amplitude de movimento deste exercício ao elevar as pernas acima da posição paralela tornará o exercício mais desafiador! Fazer uma pausa nessa posição pode até desafiar atletas avançados. Isso o conduzirá suavemente para a próxima etapa."),
        )
    }
}
