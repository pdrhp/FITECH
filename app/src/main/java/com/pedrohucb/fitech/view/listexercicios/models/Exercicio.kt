...
object ExercicioRepositorySuperiores {
    fun getExercicios(): List<Exercicio> {
        return listOf(
            ...
            Exercicio(R.drawable.sup_incline_pushups_img, "Flexão inclinada", "Peitoral, triceps e ombro", "Dificuldade: Fácil", 4,R.raw.sup_incline_pushups_4,"To make this exercise easier: A higher base makes this exercise easier.\nTo make this exercise harder: A lower base makes this exercise harder."),
